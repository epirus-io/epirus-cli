 ...
 */
package io.epirus.console.project.templates.java.erc777;

import io.epirus.console.project.templates.TemplateBuilder;

public class Erc777JavaTemplateBuilder implements TemplateBuilder {
    ...
    public Erc777JavaTemplateBuilder withGradleBuild(String gradleBuild) {
        this.gradleBuild = gradleBuild;
        return this;
    }

    public Erc777JavaTemplateBuilder withGradleSettings(String gradleSettings) {
        this.gradleSettings = gradleSettings;
        return this;
    }

    public Erc777JavaTemplateBuilder withWrapperGradleSettings(String gradlewWrapperSettings) {
        this.gradlewWrapperSettings = gradlewWrapperSettings;
        return this;
    }

    public Erc777JavaTemplateBuilder withGradleBatScript(String gradlewBatScript) {
        this.gradlewBatScript = gradlewBatScript;
        return this;
    }

    public Erc777JavaTemplateBuilder withGradleScript(String gradlewScript) {
        this.gradlewScript = gradlewScript;
        return this;
    }

    public Erc777JavaTemplateBuilder withGradlewWrapperJar(String gradlewWrapperJar) {
        this.gradlewWrapperJar = gradlewWrapperJar;
        return this;
    }

    public Erc777JavaTemplateBuilder withPackageNameReplacement(String packageNameReplacement) {
        this.packageNameReplacement = packageNameReplacement;
        return this;
    }

    public Erc777JavaTemplateBuilder withProjectNameReplacement(String projectNameReplacement) {
    ...
    public Erc777JavaTemplateBuilder withInitialSupply(String initialSupply) {
    ...
    public Erc777JavaTemplateBuilder withDefaultOperators(String[] defaultOperators) {
        if (defaultOperators != null && defaultOperators.length != 0) {
            ...
            this.defaultOperators = new String[] {};
        }
        return this;
    }

    @Override
    public Erc777JavaTemplateProvider build() {
        return new Erc777JavaTemplateProvider(
                mainJavaClass,
                null,
                null,
                gradleBuild,
